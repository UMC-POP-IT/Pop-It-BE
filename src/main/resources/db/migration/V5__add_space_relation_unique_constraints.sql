...
ALTER TABLE space_facility
    ADD CONSTRAINT uk_space_facility UNIQUE (space_id, facility_id);
...
ALTER TABLE space_image
    ADD CONSTRAINT uk_space_image_space_sort UNIQUE (space_id, sort_order);
